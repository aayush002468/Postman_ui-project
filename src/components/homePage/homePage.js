                            ...
                            <div className="footer-response-container">
                              <div className="footer-response__header">
                                <div className="response-section-top">
                                  <div className="homePage-tabs-wrapper">
                                    <div className="homePage-tabs">
                                      {responseTabs.map((tab, index) => {
                                        return (
                                          <span
                                            onClick={() =>
                                              handleResponseTab(index)
                                            }
                                            className={
                                ...
                                >
                                  <div
                                    ...
                                    style={{
                                      ...
                                      fontFamily:
                                        " IBMPlexMono Courier New  monospace",
                                    }}
                                  >
                                    <JSONPretty
                                      style={{
                                      ...
                                      mainStyle="padding:1em  overflow:hidden  background:#fafafa "
                                      valueStyle="color:#0451a5"
                                    />
                                  </div>
                                </div>
                              )}
